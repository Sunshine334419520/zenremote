...
class Singleton {
 private:
  ...
  static Type* get() {
    return subtle::GetOrCreateLazyPointer<Type>(
  ...
  static void OnExit(void* /* unused*/) {
    ...
    instance_.store(
        reinterpret_cast<Type*>(internal::kLazyDefaultInstanceState),
...
std::atomic<Type*> Singleton<Type, Traits, DifferentiatingType>::instance_ = {
    reinterpret_cast<Type*>(loki::internal::kLazyDefaultInstanceState)};
