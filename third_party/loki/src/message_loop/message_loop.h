...
#include "message_loop/incoming_task_queue.h"
...
class LOKI_EXPORT MessageLoop : public MessagePump::Delegate,
 ...
 public:
  ...
  //
  class LOKI_EXPORT DestructionObserver {
   public:
  ...
  class LOKI_EXPORT TaskObserver {
   public:
    TaskObserver();
 ...
 protected:
  ...
  // 在调用BindToCurrentThread() 之前，只有Post*Task()可以调用在这个message
  // loop上.
