...
// static of type loki::NoDestructor<T> instead:
//
// Factory& Factory::GetInstance() {
//   static loki::NoDestructor<Factory> instance;
//   return *instance;
// }
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
//
...
// loki::LazyInstance<T>::Leaky my_leaky_lazy_instance;
// instead of:
// loki::LazyInstance<T, loki::internal::LeakyLazyInstanceTraits<T> >
