...
class LOKI_EXPORT TaskRunner {
 public:
  ...
  //              FROM_HERE,
  //              loki::BindOnceClosure(&DataBuffer::AddData, buffer),
  //              loki::BindOnceClosure(&DdataLoader::OndataReceived,
  //              std::weak_ptr<DataBuffer>(buffer)));
  //      }
  //   private:
...
struct LOKI_EXPORT TaskRunnerTraits {
