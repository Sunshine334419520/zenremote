...
class LOKI_EXPORT SequencedTaskRunner : public TaskRunner {
 public:
...
// std::unique_ptr<Foo, loki::OnTaskRunnerDeleter> ptr(
//     new Foo, loki::OnTaskRunnerDeleter(my_task_runner));
struct LOKI_EXPORT OnTaskRunnerDeleter {
